  ...
  "Tokyo, Japan": {
    ...
    spots: [
      ...
      { name:"Senso-ji Shrine & Nakamise-Dori", category:"Free Activities", type:"Shrine & Market", emoji:"⛩️", budget:"Free", kidFriendly:5,
        ...
        review:"The iconic Senso-ji Shrine in Asakusa is a must, but the real gem is Nakamise-Dori — the lively market street leading up to it. Nicknamed the sweets market, it's packed with Japanese snacks, souvenirs, and unique shops on either side. We loved the dog café tucked into the extended mall — a huge hit with the kids. Visit mid-morning to beat the crowds.",
      ...
      // 📍 PLACEHOLDER — add Sweet Eats for Tokyo
      // 📍 PLACEHOLDER — add Cheap Eats for Tokyo
      // 📍 PLACEHOLDER — add Splurge pick for Tokyo
    ],
  },
};
...
function TransferTracker({ userCards }) {
  const hasCards = userCards && userCards.length > 0;
